...
namespace EvolveGames
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [HideInInspector] public PlayerCharacter _playerCharacter;
        ...
        void Update()
        {
            ...
            isRunning = !isCrough ? CanRunning ? Input.GetKey(KeyCode.LeftShift) && _playerCharacter.IsRun() : false : false;
